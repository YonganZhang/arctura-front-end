...
# EP smoke test — 方案文件指南
> 客户/合伙人专用 · 2026-04-24 · Studio Copilot v3
...
| 3D 网页预览 | exports/smoke-ep-202886.glb | ... | 客户 / 营销 |
| 3D 通用 | exports/smoke-ep-202886.obj | ... | 3D 设计师 |
| 3D 动画 | exports/smoke-ep-202886.fbx | ... | 动画 / Unity 团队 |
| BIM | exports/smoke-ep-202886.ifc | ... | BIM 工程师 |
...
**Web 3D 预览**: 把 `exports/smoke-ep-202886.glb` 拖到 https://gltf-viewer.donmccurdy.com 即可旋转/缩放查看
...
### 5️⃣ BIM 工程师 / 结构机电
**主要看**: `exports/smoke-ep-202886.ifc` (IFC4 BIM 模型)
**软件**: Revit / ArchiCAD / BlenderBIM (Blender 插件，免费) / Solibri
**能干**: 结构/机电协同、碰撞检测、工程量算量、设备联动
**3D 备份**: `exports/smoke-ep-202886.glb / .obj / .fbx` 可导入 SketchUp / Rhino / Max / Maya / Unity
...
- **smoke-ep-202886.glb**: 给客户 web 预览 (gltf-viewer.donmccurdy.com 拖入)
- **smoke-ep-202886.obj**: 给 3D 设计师 (SketchUp/Rhino)
- **smoke-ep-202886.fbx**: 给动画师 (Maya/Unity)
- **smoke-ep-202886.ifc**: 给 BIM 工程师 (Revit/ArchiCAD)
