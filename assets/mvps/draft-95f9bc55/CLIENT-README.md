...
| 3D 网页预览 | exports/draft-95f9bc55.glb | ... | 客户 / 营销 |
| 3D 通用 | exports/draft-95f9bc55.obj | ... | 3D 设计师 |
| 3D 动画 | exports/draft-95f9bc55.fbx | ... | 动画 / Unity 团队 |
| BIM | exports/draft-95f9bc55.ifc | ... | BIM 工程师 |
...
**Web 3D 预览**: 把 `exports/draft-95f9bc55.glb` 拖到 https://gltf-viewer.donmccurdy.com 即可旋转/缩放查看
...
### 5️⃣ BIM 工程师 / 结构机电
**主要看**: `exports/draft-95f9bc55.ifc` (IFC4 BIM 模型)
**软件**: Revit / ArchiCAD / BlenderBIM (Blender 插件，免费) / Solibri
**能干**: 结构/机电协同、碰撞检测、工程量算量、设备联动
**3D 备份**: `exports/draft-95f9bc55.glb / .obj / .fbx` 可导入 SketchUp / Rhino / Max / Maya / Unity
...
- **draft-95f9bc55.glb**: 给客户 web 预览 (gltf-viewer.donmccurdy.com 拖入)
- **draft-95f9bc55.obj**: 给 3D 设计师 (SketchUp/Rhino)
- **draft-95f9bc55.fbx**: 给动画师 (Maya/Unity)
- **draft-95f9bc55.ifc**: 给 BIM 工程师 (Revit/ArchiCAD)
